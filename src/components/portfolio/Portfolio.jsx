...
const items = [
    ...
    },
    {
        ...
        title:"Pod-Sphere",
        img:"./pod-sphere.png",
        desc:"Pod-Sphere is your go-to platform for all things podcasts. Discover and upload your favorite podcasts, and experience seamless text-to-speech conversion powered by AI. Stay updated with the latest episodes and transform your listening experience with Pod-Sphere.",
        link:"https://pod-sphere.vercel.app/",
    },
    {
        id:5,
        title:"Imagify",
